...
Veamos un ejemplo donde cruzamos dos tablas, la de **pobreza** y una nueva de **clasificación comunal** (urbana, mixta, rural), a partir de la columna que tienen en común: `codigo`
...
::: {.boton}
[{{< fa file-lines >}} Estimaciones de población Censo](https://github.com/bastianolea/curso_intro_R_gratis/raw/main/datos/estimaciones/estimaciones-y-proyecciones-de-población-1992-2070_base-2024_base-de-datos.xls)
:::
