...
::: {.boton}
<a href="https://github.com/bastianolea/curso_intro_R_gratis/raw/main/datos/pobreza.csv" target="_blank"> {{< fa file-download >}} Descargar datos de pobreza </a>
:::
...
Para que puedan repasar o guiarse, dejo un par de tutoriales de `{dplyr}` donde se repasan las funciones principales con datos reales:

::: {.boton .pad}
[{{< fa file-lines >}} Tutorial de datos censales ](https://bastianolea.rbind.io/blog/r_introduccion/tutorial_dplyr_censo/)
:::

::: {.boton .pad}
[{{< fa file-lines >}} Tutorial de datos sociales](https://bastianolea.rbind.io/blog/r_introduccion/tutorial_dplyr_campamentos/)
:::
...
#| eval: false
#| code-line-numbers: false
objeto |> funcion() |> función() # al objeto le aplicamos dos funciones
```
:::
::: {.fragment .pad}
